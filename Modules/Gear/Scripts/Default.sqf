...
switch (toLower(_role)) do {
	...
	case "pl": {
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			...
			[[_handFlareG,3],[_handFlareW,3],[_GLflareG,4],[_GLflareR,4]] call _addToVest
		};
	};
	...
	case "fac": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,1],[_grenademini,2]] call _addToUniform;
		[[_rifle_mag_tr,4],[_smokegrenadeY,6],[_smokegrenadeG,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
	...
	case "jtac": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_grenademini,2]] call _addToUniform;
		[[_rifle_mag_tr,3],[_smokegrenadeY,6],[_smokegrenadeG,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
		[[_battery,1],[_glsmokeR,5],[_glsmokeG,2],[_smokegrenadeG,5]] call _addToBackpack;
		if (call EFUNC(Common,isNight)) then {
			[[_chemG,5],[_chemR,5],[_handFlareG,2],[_irBeacon,3]] call _addToBackpack;
		};
		_laserDesignator call _addBino;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
	...
	case "sm": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
		[[_smokegrenadeG,3],[_grenademini,2],[_rifle_mag_tr,3]] call _addToVest;
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
			[[_handFlareG,3],[_handFlareW,3]] call _addToVest
		};
	};
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,1],[_pistol_mag,2],[_smokegrenadeY,4],[_flashbang,3]] call _addToUniform;
		[[_smokegrenadeG,3],[_grenademini,2],[_grenade,2],[_rifleGL_mag_tr,4]] call _addToVest;
		[[_rifleGL_mag,4],[_glHE,7],[_glsmokeR,5]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
	...
	case "r": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3],[_flashbang,3]] call _addToUniform;
		...
		[[_cables,3],[_defusalKit,1],[_clacker,1],[_demoCharge,2]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "g": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,1],[_pistol_mag,2],[_smokegrenadeY,3],[_flashbang,3]] call _addToUniform;
		[[_grenademini,2],[_grenade,2],[_rifleGL_mag,4],[_rifleGL_mag_tr,4],[_defusalKit,1]] call _addToVest;
	...
	case "ag": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,1],[_pistol_mag,2],[_smokegrenadeY,4],[_grenademini,2],[_flashbang,3]] call _addToUniform;
		[[_clacker,1],[_grenade,1],[_rifle_mag,4],[_rifle_mag_tr,4],[_defusalKit,1]] call _addToVest;
		[[_LMG_mag_tr,COUNT_AG_MAGS(_LMG_mag_tr)],[_demoCharge,2]] call _addToBackpack;
	...
	case "ar": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,1],[_pistol_mag,2],[_smokegrenadeY,2],[_flashbang,3]] call _addToUniform;
		[[_grenade,2],[_grenademini,2],[_Earplugs,1]] call _addToVest;
	...
	case "p": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_smokegrenadeY,2],[_smokegrenadeP,3],[_grenademini,1]] call _addToUniform;
		[[_rifleC_mag_tr,2],[_toolkit,1]] call _addToVest;
		_FAKBig call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "sapper": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeG,2],["MineDetector",1]] call _addToUniform;
		[[_rifleC_mag_tr,4],[_smokegrenadeP,3],[_grenademini,1]] call _addToVest;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "mat": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_smokegrenadeY,3],[_flashbang,3]] call _addToUniform;
	...
	case "mmg": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,1],[_pistol_mag,2],[_smokegrenadeY,2],[_grenademini,2],[_flashbang,3]] call _addToUniform;
		[[_grenade,2],[_MMG_mag,COUNT_AR_MAGS(_MMG_mag)],[_Earplugs,1]] call _addToVest;
	...
	case "marksman": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_rangecard,1],[_microDAGR,1],[_ATrag,1],[_Kestrel,1]] call _addToUniform;
	...
	case "spotter": {
		...
		[_rifle, _rifle_mag, ""] call _addPrimary;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_FAKSmall call _addToUniform;
		[[_pistol_mag,2],[_rangecard,1],[_kestrel,1]] call _addToUniform;
		[[_rifle_mag,3],[_grenademini,2],[_smokegrenadeY,6],[_smokegrenadeG,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
		[[_rifle_mag_tr,2],[_smokegrenadeG,5],[_Tripod,1]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
	...
	case "pj": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,4],[_pistol_mag,2],[_grenademini,2]] call _addToUniform;
		[[_rifle_mag_tr,3],[_smokegrenadeY,6],[_smokegrenadeG,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
		[[_smokegrenadeG,5]] call _addToBackpack;
		_FAKBig call _addToBackpack;
		if (call EFUNC(Common,isNight)) then {
