//	[side, "heli type classname" (default mid size heli of said side), "Drop/Unload", ["spawn","target","despawn"], "box content script path" or code , Boolean (Vulnerable, true or false)] execVM "Modules\NEKY_Supply\NEKY_Supply.sqf";
//
/////////////////
//	Parameters:
/////////////////
...
//	5. Box Content, either enter a script path "Modules\NEKY_Supply\Supply Box Templates\Resupply.sqf" and fill that file with items or enter it all manually using {}. Use _Box instead of "this" in the code.
...
//	null = [blufor,"","drop",["spawn","target","despawn"],"Modules\NEKY_Supply\Supply Box Templates\Resupply.sqf",false] execVM "Modules\NEKY_Supply\NEKY_Supply.sqf";
//
...
switch (_Side) do
{
	...
	case CIVILIAN:
	{
		if (_HeliClass == "") then {_HeliClass = "C_IDAP_Heli_Transport_02_F";};
		_BoxClass = "C_IDAP_CargoNet_01_supplies_F";
		_ChuteClass = "I_Parachute_02_F";
		_PilotClass = "C_Man_Pilot_F";
	};
};
