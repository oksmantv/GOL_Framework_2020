//	[player, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick {[blufor,"","drop",["spawn",_pos,"despawn"],"",false] execVM "Modules\NEKY_Supply\NEKY_SupplyInit.sqf"};
//
...
_BoxCode = [_This, 4, "Modules\NEKY_Supply\NEKY_SupplyBox.sqf", ["", {}]] call BIS_fnc_Param;
_Vulnerable = [_This, 5, false, [false]] call BIS_fnc_Param;

//	Run main script
[[[_Side,_HeliClass,_Type,_STDs,_BoxCode,_Vulnerable], "Modules\NEKY_Supply\NEKY_Supply.sqf"], "BIS_fnc_ExecVM", false] call BIS_fnc_MP;
