//	null = [This, Radius, (is a Mobile Service Station), ["NearestObjects"]] ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf";
///////////////////////////////////////////
//
...
//////////////
//
//	1. Place this file accompanied by NEKY_MobileSS.sqf and NEKY_Settings.sqf in: yourmissionfolder\Modules\NEKY_ServiceStation\
...
//	Examples:
///////////////
//	null = [This, nil, false, ["LandVehicle","AIR"]] ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf";
//	null = [Helipad, 15, false, ["LandVehicle"]] ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf";
//	null = [This, nil] ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf";
//	null = [This] ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf";
///////////////
///////////////
...
//ACE supply variable
	_SS setVariable["ace_rearm_isSupplyVehicle",true];
