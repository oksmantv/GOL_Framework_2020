//	null = [This, Radius, (is a Mobile Service Station), ["NearestObjects"]] execVM "Modules\NEKY_ServiceStation\MobileSS.sqf";
///////////////////////////////////////////
//
...
//	Examples:
///////////////
//	null = [This, nil, True, ["LandVehicle","AIR"]] ExecVM "Modules\NEKY_ServiceStation\MobileSS.sqf";
//	null = [RepairTruck, 15, True, ["LandVehicle"]] ExecVM "Modules\NEKY_ServiceStation\MobileSS.sqf";
//	null = [This, nil] ExecVM "Modules\NEKY_ServiceStation\MobileSS.sqf";
//	null = [This] ExecVM "Modules\NEKY_ServiceStation\MobileSS.sqf";
///////////////
///////////////
...
_Object setVariable["ace_rearm_isSupplyVehicle",true];
_Object addAction ["<t color='#00FF00'>Activate Service Station</t>",
{
	...
	[[_Object,_MRadius,_IsMSS,_Filter],{_This ExecVM "Modules\NEKY_ServiceStation\ServiceStation.sqf"}] RemoteExec ["BIS_FNC_SPAWN",0];
