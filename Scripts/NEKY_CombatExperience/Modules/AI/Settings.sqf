...
_ShareTo = ["MAN"];										// What kinds of groups information will be shared to. "MAN" = Infantry, "LANDVEHICLE" = Cars, IFV's, tanks etc. "AIR" = Aerial vehicles. These can be combined, ["MAN","LANDVEHICLE","AIR"].
NEKY_AI_ShareRange = 800;	// All friendly AI within this range will be informed of the enemies.
NEKY_AI_ShareQuality = [0.3,0.4]	// This array sets the minimum and maximum quality of the information sent to friendly groups. 0 = 0%, 1 = 100%. [0.1, 0.8], 0.1 (10%) to 0.8 (80%) quality of original information will be transmitted from reporter to friendly reciever, the quality drops based upon distance to friendly, further away, less quality, closer, higher quality.