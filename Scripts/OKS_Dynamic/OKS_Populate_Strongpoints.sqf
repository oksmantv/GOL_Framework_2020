...
Params["_MainTrigger","_Side","_InfantryNumber","_Units","_SideMarker","_SideColor","_Settings"];
private ["_House","_AllBuildings","_buildingArray","_SelectedBuildings","_HouseCount","_i","_HouseMax","_Strongpoint","_Location","_CountStrongpoints","_Group","_GarrisonNumber","_Location","_Debug_Variable","_Strongpoint","_SortedBuildings","_SafePos","_Marker","_AllNumbers","_SelectedStrongpoints","_Strongpoints","_MarkerPos"];
...
_Strongpoints = [];

			{
				...
				_Location = nearestBuilding (locationPosition _X);
			...
			} foreach nearestLocations [_MainTrigger,["NameVillage","NameCity","NameCityCapital","Hill","Name","NameLocal","fakeTown"],(TriggerArea _MainTrigger select 0)];
...

	{
		...
		[_MarkerPos,"sector",125,_Side,_Settings] spawn OKS_CreateObjectives;

			{
				...
				[_Group, _SafePos, 120] call CBA_fnc_taskPatrol;
