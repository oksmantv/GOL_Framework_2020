	...
	Params["_Area","_NumberOfVehicles","_Range","_Type","_Vehicles","_Units"];
	Private ["_SafePos","_nearRoads","_road","_roadConnectedTo","_connectedRoad","_direction","_VehicleWaypoints","_SelectedVehicles","_Debug_Variable"];
	...
	For "_i" to (_NumberOfVehicles - 1) do {
		...
		_Vehicle = CreateVehicle [_VehicleClass, _SafePos, [], 0, "CAN_COLLIDE"];
