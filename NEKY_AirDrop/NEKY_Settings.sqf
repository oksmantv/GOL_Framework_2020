...
_AirbaseRespawnTimer = 600; 	// Timer until allowed to respawn another wave of reinforcements. How its calculated: ThisTime + (random ThisTime) so 300+(randomly between 1-300).
